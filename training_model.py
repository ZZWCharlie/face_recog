...
def main():
    ...
    # 加载 YOLOv8 模型
    #model = YOLO('D:/VScode/xiangmu/recognize-main/yolov8x.pt')  # 加载预训练的基础模型
    model = YOLO('D:/VScode/xiangmu/recognize-main/yolov8s.pt')  # 加载预训练的基础模型
    ...
    results = model.train(
        ...
        name='face_expression_model_new'
    )
