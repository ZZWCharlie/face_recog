...
# 加载 YOLO 模型
try:
    #model = YOLO('D:/VScode/xiangmu/recognize-main/runs/train/face_expression_model4/weights/best.pt')
    #model = YOLO('D:/VScode/xiangmu/recognize-main/runs/train/face_expression_model_new/weights/best.pt')
    model = YOLO('D:/VScode/xiangmu/recognize-main/runs/train/fer2013_optimized/weights/best.pt')
...
class MainWindow(QMainWindow):
    ...
    def detect_faces_and_expressions(self):
        ...
        try:
            ...
            output_dir = "D:/VScode/xiangmu/recognize-main/outputs"
